...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_GB10_2022.csv")
...
write_csv(out3, "data_model_outputs/GB10_daily_full_030723.csv")
write_csv(fit_clean, "data_model_outputs/GB10_summary_clean_030723.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/GB10fit_2022_030723.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/GB10metab_2022_030723.png",
       width=8, height=4.5, dpi=300)
