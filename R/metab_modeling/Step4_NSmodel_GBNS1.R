...
# Read data in
data <- read_rdump("data_working/GBNS1_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 17.16824
data$temp_ref <- 17.16824
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_GBNS1_2022.csv")
...
write_csv(out3, "data_model_outputs/GBNS1_daily_full_030123.csv")
write_csv(fit_clean, "data_model_outputs/GBNS1_summary_clean_030123.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/GBNS1fit_2022_030123.png",
