...
# Read data in
data <- read_rdump("data_working/BW20_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 8.731275
data$temp_ref <- 8.731275
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_BW20_2022.csv")
...
write_csv(out3, "data_model_outputs/BW20_daily_full_031623.csv")
write_csv(fit_clean, "data_model_outputs/BW20_summary_clean_031623.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/BW20fit_2022_031623.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/BW20metab_2022_031623.png",
       width=8, height=4.5, dpi=300)
