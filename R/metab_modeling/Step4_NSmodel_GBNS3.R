...
# Read data in
data <- read_rdump("data_working/GBNS3_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 17.18537
data$temp_ref <- 17.18537
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_GBNS3_2022.csv")
...
write_csv(out3, "data_model_outputs/GBNS3_daily_full_030623.csv")
write_csv(fit_clean, "data_model_outputs/GBNS3_summary_clean_030623.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/GBNS3fit_2022_030623.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/GBNS3metab_2022_030623.png",
       width=8, height=4.5, dpi=300)
