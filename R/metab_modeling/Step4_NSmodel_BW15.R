...
# Read data in
data <- read_rdump("data_working/BW15_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 7.879267
data$temp_ref <- 7.879267
...
#### Fit model ####
# Note, Kelly approximates this takes 6 hours for 4 months of data on the server.
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_BW15_2022.csv")
...
write_csv(out3, "data_model_outputs/BW15_daily_full_031523.csv")
write_csv(fit_clean, "data_model_outputs/BW15_summary_clean_031523.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/BW15fit_2022_031523.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/BW15metab_2022_031523.png",
       width=8, height=4.5, dpi=300)
