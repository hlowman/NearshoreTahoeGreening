...
# Read data in
data <- read_rdump("data_working/GBNS2_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 17.13541
data$temp_ref <- 17.13541
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_GBNS2_2022.csv")
...
write_csv(out3, "data_model_outputs/GBNS2_daily_full_030623.csv")
write_csv(fit_clean, "data_model_outputs/GBNS2_summary_clean_030623.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/GBNS2fit_2022_030623.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/GBNS2metab_2022_030623.png",
       width=8, height=4.5, dpi=300)
