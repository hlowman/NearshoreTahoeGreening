...
# Read data in
data <- read_rdump("data_working/GB15_2022_sonde_list.R")

# Set reference temperature
# mean(data$temp) # 11.30894
data$temp_ref <- 11.30894
...
# Read in input data
sonde_data <- read_csv("data_working/sonde_prep_GB15_2022.csv")
...
write_csv(out3, "data_model_outputs/GB15_daily_full_031323.csv")
write_csv(fit_clean, "data_model_outputs/GB15_summary_clean_031323.csv")
...
# Export figure.
ggsave(plot = p1,filename = "figures/GB15fit_2022_031323.png",
...
# Export figure.
ggsave(plot = p2,filename = "figures/GB15metab_2022_013723.png",
       width=8, height=4.5, dpi=300)
